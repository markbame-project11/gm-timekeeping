<?php
            ...
            require_once "/Applications/XAMPP/htdocs/root/lib/vendor/PHPExcel/Classes/PHPExcel/IOFactory.php";
					...
					*/
					...
					$pdo = new PDO($dsn, $user, $password);  
					 ...
					 for($i=1; $i<=$highestRow; $i++)
					   ...
					   //~~$gross_pay = $objWorksheet->getCellByColumnAndRow(21,$i)->getValue();
