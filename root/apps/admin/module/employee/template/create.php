...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form method="post" action="<?php echo $ccConfig->get('base_url').'/employee/create'; ?>" role="form" clas="form-horizontal">
				<fieldset style="width: 850px;">
					...
					<div class="form-group clearfix">
						<label for="inputUsername" class="col-sm-3 control-label">Username : <span style="color:red;">*</span> </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="inputUsername" value="<?php echo $fields['username']; ?>" name="username" />
						</div>
					</div>
					...
					<div class="form-actions">
						<input type="submit" name="Submit" value="Create Employee" class="btn btn-primary" />
